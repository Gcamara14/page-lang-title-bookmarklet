...
function listThingsWithTitles(){
  ...
  s+='<table border="1" cellpadding="5"><caption>The aria-label affects accessibility and must be translated. Use the xPath to help you locate the element. It can be pasted in the DOM search field.</caption><thead><tr valign=top><th scope="col">Aria-Label (Translate)</th><th>On-screen text</th><th>xPath</th><th scope="col">Code OuterHTML</th><th>Notes</th></tr></thead><tbody>' + row + '</tbody></table>';

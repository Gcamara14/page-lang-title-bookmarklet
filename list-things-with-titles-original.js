...
function listThingsWithTitles(){
  ...
  if (identCount>0) {s+='<input type="checkbox" id="showPotentialProblemsOnly"><label for="showPotentialProblemsOnly">Show only elements with definite title issues(' + issueCount + ').</label><br>';/*s+=identCount + ' elements with identical titles were found.';*/}
